...
BLOG_AUTHOR = "Website Development Incorporated"  # (translatable)
BLOG_TITLE = "Iran Information"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://iran-information.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://iran-information.github.io/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "UNSC Statements by Iran"  # (translatable)
...
NAVIGATION_ALT_LINKS = {
    ...
    "en": (
        ...
        (
            (
                ('/en/statement/introduction/', 'Introduction to Statements I'),
                ('/en/statement/2006-07-31-pv5500-res1696-2006-ip/', 'UNSC 5500 - Resolution 1696(2006)'),
                ('/en/statement/2006-12-23-pv5612-res1737-2006-ip/', 'UNSC 5612 - Resolution 1737(2006)'),
                ('/en/statement/2007-03-24-pv5647-res1747-2007-ip/', 'UNSC 5647 - Resolution 1747(2007)'), 
                ('/en/statement/2008-03-03-pv5848-res1803-2008-ip/', 'UNSC 5848 - Resolution 1803(2008)'),
                ('/en/statement/2010-06-09-pv6335-res1929-2010-ip/', 'UNSC 6335 - Resolution 1929(2010)'),
                ('/en/statement/2015-07-20-pv7488-res2231-2015-ip/', 'UNSC 7488 - Resolution 2231(2015)'),
                #('/statement/2015-07-20-pv7488-res2231-2015-ip/', '———————————————'), # 15 dashes
                # Inserts a space or dashes in the drop-down menu, but make it go to the item above.                
            ),
             '2006 to 2231(2015)'
        ),
        (
            (
                ('/en/statement1/introduction1/', 'Introduction to Statements II'),
                ('/en/statement1/2018-12-12-pv8418-ip/', 'UNSC 8418 - 2018-12-12'),
                ('/en/statement1/2019-06-26-pv8564-ip/', 'UNSC 8564 - 2019-06-26'),
                ('/en/statement1/2019-12-19-pv8695-ip/', 'UNSC 8695 - 2019-12-19'),
                ('/en/statement1/2020-08-17-res-draft-2020-805-ip/', 'UNSC Written - 2020-08-17'),
                ('/en/statement1/2021-06-30-pv8811-ip/', 'UNSC 8811 - 2021-06-30'),
                ('/en/statement1/2021-12-14-pv8930-ip/', 'UNSC 8930 - 2021-12-14'),
                ('/en/statement1/2022-06-30-pv9085-ip/', 'UNSC 9085 - 2022-06-30'),
                ('/en/statement1/2022-12-19-pv9225-ip/', 'UNSC 9225 - 2022-12-19'),
                ('/en/statement1/2023-07-06-pv9367-ip/', 'UNSC 9367 - 2023-07-06'),
                ('/en/statement1/2023-12-18-pv9511-ip/', 'UNSC 9511 - 2023-12-18'),
    ...
    "fr": (
        ...
        (
            (
                ('/fr/statement/introduction/', 'Introduction aux énoncés I'),
                ('/fr/statement/2006-07-31-pv5500-res1696-2006-ip/', 'CSNU 5500 - Résolution 1696(2006)'),
                ('/fr/statement/2006-12-23-pv5612-res1737-2006-ip/', 'CSNU 5612 - Résolution 1737(2006)'),
                ('/fr/statement/2007-03-24-pv5647-res1747-2007-ip/', 'CSNU 5647 - Résolution 1747(2007)'), 
                ('/fr/statement/2008-03-03-pv5848-res1803-2008-ip/', 'CSNU 5848 - Résolution 1803(2008)'),
                ('/fr/statement/2010-06-09-pv6335-res1929-2010-ip/', 'CSNU 6335 - Résolution 1929(2010)'),
                ('/fr/statement/2015-07-20-pv7488-res2231-2015-ip/', 'CSNU 7488 - Résolution 2231(2015)'),
            ),
             '2006 to 2231(2015)'
        ),
        (
            (                
                ('/fr/statement1/introduction1/', 'Introduction aux énoncés II'),
                ('/fr/statement1/2018-12-12-pv8418-ip/', 'CSNU 8418 - 2018-12-12'),
                ('/fr/statement1/2019-06-26-pv8564-ip/', 'CSNU 8564 - 2019-06-26'),
                ('/fr/statement1/2019-12-19-pv8695-ip/', 'CSNU 8695 - 2019-12-19'),
                ('/fr/statement1/2020-08-17-res-draft-2020-805-ip/', 'CSNU Written - 2020-08-17'),
                ('/fr/statement1/2021-06-30-pv8811-ip/', 'CSNU 8811 - 2021-06-30'),
                ('/fr/statement1/2021-12-14-pv8930-ip/', 'CSNU 8930 - 2021-12-14'),
                ('/fr/statement1/2022-06-30-pv9085-ip/', 'CSNU 9085 - 2022-06-30'),
                ('/fr/statement1/2022-12-19-pv9225-ip/', 'CSNU 9225 - 2022-12-19'),
                ('/fr/statement1/2023-07-06-pv9367-ip/', 'CSNU 9367 - 2023-07-06'),
...
THEME_CONFIG = {
    DEFAULT_LANG: {
         ...
         # navbar_light: False displays a black background with white text.
         'navbar_light': False,
         # Use a custom navbar color. If unset, 'navbar_light' sets text +
         # background color. If set, navbar_light controls only background
         # color. Supported values: bg-dark black, bg-light light-grey, bg-primary, bg-secondary,
         # bg-success green, bg-danger, bg-warning, bg-info teal, bg-white, bg-transparent.
         'navbar_custom_bg': 'bg-success',
    }
}
...
# LOGO_URL = ''
# *
LOGO_URL = '/images/website-logo.svg'
...
FAVICONS = (
     ...
     ("icon", "/images/favicon-flag.svg", "32x32"), 
     ("icon", "/images/favicon-flag.svg", "48x48"),              
)
...
# (translatable)
#CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered 
#by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
# Change footer was:  Contents © 2025 Website Developer - Powered by Nikola
